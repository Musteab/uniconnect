    ...
    <footer className="border-t border-white/10 mt-10">
      <div className="container-px max-w-7xl mx-auto py-8 pb-16 sm:pb-8 text-sm text-dark/70 flex flex-col sm:flex-row items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-4">
          ...
          <a href="https://www.tiktok.com/@uni_connect24?_r=1&_t=ZM-91Le4VdK7LM" target="_blank" rel="noreferrer" aria-label="TikTok" className="hover:text-accent transition-colors">
            {/* TikTok */}
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
